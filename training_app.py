...
def load_deputies_data():
    # Controlla se i file di dati esistono. Se no, stampa un errore e restituisci una lista vuota.
    try:
...
# Questo codice viene eseguito UNA SOLA VOLTA all'avvio dell'applicazione sul server.
...
if __name__ == '__main__':
    # Questo blocco viene usato solo per lo sviluppo locale
